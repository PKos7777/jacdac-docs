...
### Problem / Challenge
Even just focusoing on Mute-status/control could be powerful.  This is always a popular topic and we could make it really easy to build cool solutions. Combining with a single Braille-cell we can have a Mute-status for vision-impaired-users.
...
## Challenge 29: Help Darkstar Inteface the Backscatter (no-power) Controller to XBox
